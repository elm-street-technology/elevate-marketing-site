...
import lnTop from "../images/lead-nurture-top.png";
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        <div style={{backgroundColor:"#f49b26", textAlign:"center", padding:"15px"}}><span className={classes.bold} style={{color:"#ffffff"}}>REGISTER TODAY by selecting from any upcoming date/time slots</span></div>
...
export const query = graphql`
  query eventLNQuery {
    allContentfulEvent(limit: 1000, filter: {eventType: {eq: "LN"}}, sort: { fields: [datetime], order: ASC }) {
      edges {
        node {
          datetime
          id
