...
const Leadgenerationsecretsauce = ({ children, classes, data, tags }) => {
  const postNode = {
    title: `Lead Generation Secret Sauce - ${config.siteTitle}`,
  };

  return (
    <div className={classes.root}>
      <Helmet>
        <title>{`Lead Generation Secret Sauce - ${config.siteTitle}`}</title>
      </Helmet>
      <SEO postNode={postNode} pagePath="Lead Generation Secret Sauce" />


<Container>
    <div style={{paddingBottom:"50px", textAlign:"center"}}>
    <img src={Secretlogo} width="100%"  style={{paddingBottom:"25px", paddingTop:"20px", maxWidth:"438px", textAlign:"center"}}/>
      <br />
