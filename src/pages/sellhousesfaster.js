...
import SignUpFormFaster from "../components/SignUpFormFaster";
import Covid from "../images/covid_header.jpg";
import Ss1 from "../images/ss_chart1.jpg";
import Ss2 from "../images/ss_chart2.jpg";
import SEO from "../components/SEO";

const Sellhousesfaster = ({ children, classes, data, tags }) => {
  const postNode = {
    title: `Marketing Secretsto Sell More Houses Faster - ${config.siteTitle}`,
  };

  return (
    <div className={classes.root}>
      <Helmet>
        <title>{`Marketing Secretsto Sell More Houses Faster - ${config.siteTitle}`}</title>
      </Helmet>
      <SEO postNode={postNode} pagePath="Marketing Secretsto Sell More Houses Faster" />


<Container>
    <div style={{paddingBottom:"50px", textAlign:"center", paddingTop:"20px"}}>
    <h1 className={classes.heading} style={{color:"#38195f",}}>Marketing Secretsto Sell<br />
    MORE Houses...Faster</h1>
      <br />
