    ...
    <div className={classes.root}>
          ...
          >
            <div className={classes.centerHeading}>
              ...
              <div className={classes.subtext} style={{ color: "#ffffff" }}>
                We loved connecting with you. Let’s keep that connection
                going...
              </div>
            </div>
          </div>
          ...
          <div className={classes.top}>
            ...
            >
              ...
              <div className={classes.bold}>
                I want to learn more about Elevate.
              </div>
      ...
      >
        <Container>
          ...
          >
            ...
            <div className={classes.bold} style={{ color: "#FFFFFF" }}>
              Welcome, you smart cookie! This section is for YOU.
            </div>

            <div style={{ color: "#e4e8ea" }}>
              It takes about 24-hours to process your order. Once processed, you
              will hear from our Success Team with next steps. <br />
              In the meantime, get a head-start on “all things Elevate” with our
              helpful resources:
            </div>
          </div>
          ...
          <div className={classes.top}>
            ...
            >
              ...
              <a
                target="_blank"
                href="/assets/elevate_getting_started_ebook.pdf"
        ...
        <Container>
          <div className={classes.top}>
            <div className={classes.centerHeading}>
              ...
              Sweet! Take a quick video tour below and then connect with a
              Success Coach.
              <div
                style={{
                  textAlign: "center",
              ...
              >
                ...
                >
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/WMqvFA708ss "
                    frameborder="0"
      ...
      <div
        style={{
          ...
          backgroundImage: "url(" + Extras2bg + ")",
        }}
      >
        <Container>
          <div
            className={classes.top}
            style={{ paddingBottom: "45px", paddingTop: "50px" }}
          >
            <div className={classes.centerHeading}>
              <div className={classes.heading} style={{ color: "#ffffff" }}>
              ...
              <div style={{ color: "#ffffff" }}>
                We’ve got tons to share...and sharing is caring.
              </div>
            </div>
          </div>
          ...
          <div className={classes.top}>
            ...
            >
              ...
              <div style={{ color: "#ffffff" }}>
                Every morning, we’ll send a marketing tip,
                <br />
            ...
            >
              ...
              <div style={{ color: "#ffffff" }}>
                ...
                <br />
                “Casual Conversations” video series,
                <br />
                great articles &amp; client insight.
              </div>

              <a
                href="https://tryelevate.com/blog"
                className={classes.getStartedLink2}
              >
                View Now
              </a>
            ...
            >
              ...
              <div className={classes.heading2} style={{ color: "#ffffff" }}>
                6 Emails Every Real Estate
                <br />
                Agent Should Be Sending
              </div>
              <div style={{ color: "#ffffff" }}>
                Easy to implement, proven to deliver emails designed to nurture
                your clients.
              </div>
            ...
            >
              ...
              <div style={{ color: "#ffffff", paddingBottom: "20px" }}>
                Follow us on your favorite social media channels for daily,
                <br />
                weekly &amp; monthly real estate inspirations. We’ve got you
                covered!
              </div>

              <a target="_blank" href="https://www.facebook.com/TryElevateRE/">
                <img src={Fb} width="45" style={{ paddingRight: "4px" }} />
              </a>
              <a target="_blank" href="https://twitter.com/TryElevateRE">
                <img src={Tw} width="45" style={{ paddingRight: "4px" }} />
              </a>
              <a
                target="_blank"
                href="https://www.linkedin.com/showcase/tryelevatere/"
              >
                <img src={Li} width="45" style={{ paddingRight: "4px" }} />
              </a>
              <a
                target="_blank"
                href="https://www.youtube.com/channel/UCKVavElvMaRgAHdpMXF8O9A"
              >
                <img src={Yt} width="45" style={{ paddingRight: "4px" }} />
              </a>
              <a target="_blank" href="https://www.instagram.com/tryelevatere/">
                <img src={Insta} width="45" style={{ paddingRight: "4px" }} />
              </a>
            </div>
          </div>
        </Container>
