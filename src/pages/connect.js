...
const connect = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <PageTitleImage title="The power of CONNECTION" image={WideImage}>
      Know that warm, fuzzy feeling that comes when you connect with someone who’s really awesome?  Let’s make that happen.
      </PageTitleImage>
