...
const crm = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <PageTitleImage title="The power of PRODUCTIVITY" image={WideImage}>
      Sell more...faster.  Streamline your day-to-day lead management, nurturing &amp; conversion with ONE intuitive solution.
      </PageTitleImage>
