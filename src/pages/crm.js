...
import LandingHeader from "../images/crm_top_image.jpg";
import LandingFooter from "../images/crm_bottom_image.jpg";

const Crm = ({ children, classes, data, tags }) => {
  const postNode = {
  ...
  return (
    <div className={classes.root}>
      ...
      <SEO postNode={postNode} pagePath="crm" customTitle />
