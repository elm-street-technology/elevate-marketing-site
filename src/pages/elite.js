...
import Eliteprice from "../images/elite_price.png";
...
const Elite = ({ children, classes, data, tags }) => {
  const postNode = {
      title: `Elevate Elite - ${config.siteTitle}`,
  };

  return (
<div className={classes.root}>
      <Helmet>
              <title>{`Elevate Elite - ${config.siteTitle}`}</title>
      </Helmet>
...
<Container>
      ...
      <img src={Eliteprice} width="100%"  style={{maxWidth:"280px"}} />
            </div>
