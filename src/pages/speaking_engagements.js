...
const speaking_engagements = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <PageTitleImage title="The power of THOUGHT" image={WideImage}>
      Looking for engaging, insightful thought leadership for your next event?  Explore our panel of speakers &amp; topics.
      </PageTitleImage>
