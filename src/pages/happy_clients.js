...
const happy_clients = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <PageTitleImage title="The power of SUCCESS" image={WideImage}>
      Nothing feels better than happy clients celebrating their productivity, success &amp; growth using Elevate.
      </PageTitleImage>
