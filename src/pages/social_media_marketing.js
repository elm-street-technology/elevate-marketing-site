...
const social_media_marketing = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <PageTitleImage title="The power of COMMUNITY" image={WideImage}>
      <span style={{ fontWeight: "bold" }}>Strategic, engaging social media</span>automatically served<br />
      to your online audience, whether you are online or on vacation.
      </PageTitleImage>
