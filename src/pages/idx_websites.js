...
const Demo = ({ classes }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <PageTitleImage title="The power of PRESENTATION" image={WideImage}>
      High SEO, <span style={{ fontWeight: "bold" }}>gorgeous interactive websites</span> that help build<br />
      your brand and support your client’s needs.
      </PageTitleImage>
