...
class Formdylan extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
      ...
      return (
        ...
        >
          <div >
            ...
            You will now receive notifications about future webinars, additional insights and inspiration from Dylan to empower your social media marketing, and even more great content to feed your brain!
            </Typography>
          </div>
        </div>
      );
