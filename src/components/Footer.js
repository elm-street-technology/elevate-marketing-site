  ...
  <div className={classes.root}>
      ...
      <div className={classes.flexContainer}>
        ...
        <div className={classes.flexContainer}>
          ...
          <div className={classes.logocenterMobile}>
            <Link to="/">
            ...
            <a
              ...
              target={"_blank"}
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 24" style={{width:"230px",}}>
                <defs>
                  <linearGradient
                    id="linear-gradient"
                    x1="20.21"
                ...
                <div className={classes.flexItem2}>
                  ...
                  <div className={classes.centerMobile}>
                    <Link to="/get-started" className={classes.footercta}>Terms of Use</Link>
                    <Link to="/get-started" className={classes.footercta}>Pricing &amp; Refund Policy</Link>
