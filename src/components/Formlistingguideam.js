...
class Formlistingguide extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
      ...
      return (
        ...
        >
          <div >
            ...
            <a className={classes.signUpBtn} href="/assets/listings.pdf">Download the PDF</a>
            </div>
      ...
      <div className={classNames(classes.root, className)}>
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            ...
            var meeting_request = '';
            var notes = 'Interests: ';
            var lead_source = 'tryelevate.com:listings';
            Object.keys(values).forEach(function (key, index) {
              ...
              if (key == "amrequest"){
                if(values.amrequest) {
                    lead_source = 'tryelevate.com:listingsAM';
                }
              }
            });
          ...
          render={({ values, isSubmitting,handleBlur, handleChange }) => (
            <Form noValidate>
             ...
             <Field id="demorequest" name="demorequest" type="checkbox" value="yes" className={classes.checkfield} style={{marginLeft:"0px",marginRight:"15px"}} />
              ...
              <div>
              <Field id="amrequest" name="amrequest" type="checkbox" value="yes" className={classes.checkfield} style={{marginLeft:"0px",marginRight:"15px"}} />
              <span style={{fontSize:"16px"}}>Schedule a demo of AgentMarketing</span>
              </div>
              </div>
              <button
                type="submit"
