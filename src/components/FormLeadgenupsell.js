          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              <div style={{ marginBottom: "30px" }}>
                <div className={classes.headingLarge}>ELEVATE SUBSCRIBERS</div>
                ...
                >
                  Upgrade your Elevate account (by Friday, Aug. 30th) to include
                  one of our lead generation solutions & receive an ADDITIONAL
                  $50/m in lead generation ad spend for ONE FULL YEAR (giving
                  you an average of 3 - 5 FREE leads per month on top of all of
                  the rest!).
                </div>
              </div>
              <div
              ...
              >
                ...
                <div style={{ fontSize: "11px", paddingTop: "16px" }}>
                  ...
                  <br />
                  Offer only valid for active Elevate subscribers of Social Pro
                  or DMS.
                </div>
                <button
                  type="submit"
