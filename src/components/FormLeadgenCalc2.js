...
class FormLeadgenCalc2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
            ...
            <Form noValidate>
              ...
              <Field
                ...
                items={[
                  ...
                  {
                    label:
                      "Broker - Looking for leads for my brokerage and/or agents",
                    value: "Broker",
                  },
                  {
                    label:
                      "Existing client - Looking to add lead generation to my Elevate solution",
