...
class FormMastermind extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
          ...
          render={({ values, isSubmitting,handleBlur, handleChange }) => (
            <Form noValidate>
              <div style={{marginBottom:"30px"}}>
                ...
                <div className={classes.headingText} style={{ marginTop: "20px" }}>Or, call 833.303.1040 to speak to an Elevate Success Coach NOW</div>
                </div>
