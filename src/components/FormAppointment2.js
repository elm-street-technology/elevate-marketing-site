...
class FormAppointment2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
...
You can also speak to a member of our lead generation team immediately by calling <a href="tel:18449720260" className={classes.link}>844.972.0260</a>.
    ...
    return <div className={classNames(classes.root, className)}>
        <Formik initialValues={{ firstname: "", lastname: "", company: "", email: "", phone: "", form: "appointment_form2" }} validationSchema={() => Yup.object().shape(
              {
