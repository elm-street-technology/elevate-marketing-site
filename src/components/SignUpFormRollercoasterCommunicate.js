...
class SignUpFormRollercoasterCommunicate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
        ...
        <Formik
          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              <Typography
                type="heading6"
                style={{ textAlign: "center", color: "#888f96" }}
              />
              ...
              <Field
                ...
                items={[
                  {
                    label:
                      "Existing client – looking to connect to review my account & make sure I’m doing everything I can!",
                    value: "Existing Client",
                  },
                  {
                    label:
                      "An agent – looking to schedule my 15-minute online marketing evaluation.",
                    value: "Agent",
                  },
                  {
                    label:
                      "A broker – interested in scheduling my gap analysis.",
                    value: "Broker",
                  },
                  {
...
}))(SignUpFormRollercoasterCommunicate);
