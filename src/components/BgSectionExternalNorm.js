...
const BgSectionExternalNorm = ({
  ...
  return (
      ...
      <div className={classNames(classes.root, className)}>
          <div className={classes.titlearea} style={{ backgroundColor: "#39225d" }}>
                ...
                <div className={classes.flexItem} style={{paddingLeft:"20px", paddingRight:"20px", paddingTop:"45px"}}>
                    ...
                    <div className={classes.subHeading2} style={{paddingBottom:"20px"}}><div className={classes.bold}>Download &amp; Print</div></div>
