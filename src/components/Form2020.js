          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              <div style={{ marginBottom: "30px" }}>
                ...
                >
                  The average real estate agent spends 9-hrs a week working on
                  social media marketing. With Elevate, we reduce that time to
                  literally minutes instead of hours! Take a tour of our
                  marketing automation services for websites, blogs, social
                  media, email and more...and consider your 2020 social media
                  marketing DONE!
                </div>
              </div>
              <div
