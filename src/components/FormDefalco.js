        ...
        >
          <div>
            ...
            <Typography type="heading5" gutterTop>
              A member of the Elevate team will be in touch with you shortly.
              <br />
              <br />
            </Typography>
          </div>
        ...
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            ...
            const body = {
              ...
              markets:
                values.market1 + "," + values.market2 + "," + values.market3,
            ...
            <Form noValidate>
              ...
              >
                ...
                <div style={{ marginTop: "16px", marginBottom: "10px" }}>
                  ...
                  />
                  <div className={classes.checkboxDesc}>
                    <span style={{ fontWeight: "700" }}>DMS&trade;</span> -
                    "Help build my online marketing"
                  </div>
                </div>
                <div>
                  <Field
                  ...
                  />
                  <div className={classes.checkboxDesc}>
                    <span style={{ fontWeight: "700" }}>Elite&trade;</span> -
                    "Send me lots of buyer / seller leads!"
                  </div>
                </div>
                <div
                  style={{
