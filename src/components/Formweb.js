          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              <div style={{ marginBottom: "30px" }}>
                ...
                >
                  Get a stunning IDX website,
                  <br />
                  starting as low as $150/m.
                </div>
                <div
                  style={{
                    color: "#495050",
                ...
                >
                  Get a stunning IDX website, starting as low as $150/m. All
                  Elevate IDX websites come with a full CRM, social media, email
                  and text marketing, and fanatical training and support...
                  starting as low as $150/m. Watch our quick video and then
                  schedule
                  <br />
                  your 15-minute demo TODAY to learn more.
                </div>
              ...
              >
                ...
                <Field
                  ...
                  items={[
                    {
                      label:
                        "Digital Marketing Services (Website, Email, Social, etc.)",
                      value:
                        "Digital Marketing Services (Website, Email, Social, etc.)",
                    },
                    {
