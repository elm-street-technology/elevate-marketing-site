          ...
          <div>
            ...
            <div style={{ margin: "50px" }}>
              <a
                ...
                href="/assets/elevate_kardashian.pdf"
              >
                Download the PDF
              </a>
            </div>
          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              <div style={{ marginBottom: "30px" }}>
                ...
                >
                  6 Real Estate Lessons From Kim Kardashian - FREE Download
                </div>
                ...
                >
                  What can Kim Kardashian teach real estate agents about
                  marketing? A lot! Download your free guide, filled with real
                  life examples to take your real estate brand to the next
                  level.
                </div>
              </div>
              <div
