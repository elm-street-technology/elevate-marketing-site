...
class Formsummer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
        ...
        <Formik
          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: "16px" }}>
                    I would like a 15-minute tour of Elevate's DMS solution.
                  </span>
                </div>
              ...
              >
                Accepting registrations through July 31, 2020, 12pm PST.
                <br />
                Giveaway recipient will receive twelve (12) months of Elevate’s
                DMS service.
                <br />A valid credit card is required to be on file for account
                upgrades and/or additional purchases.
                <br />
                Valid for real estate agents in supported MLS markets across the
                U.S.
                <br />
                Cannot be an active Elevate subscriber.
                <br />
