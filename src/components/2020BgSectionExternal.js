  ...
  return (
      ...
      <div className={classNames(classes.root, className)}>
          <div className={classes.titlearea} style={{ backgroundImage: "url(" + bgImage + ")",backgroundSize:"cover", backgroundPosition:"centerTop" }}>
                ...
                <div className={classes.flexItem} style={{paddingLeft:"40px", paddingRight:"40px", paddingTop:"55px", paddingBottom:"65px",}}>
                    <h1 className={classes.leftheading}>{secTitle}</h1>
                    <div className={classes.subHeading}>Make It Your Best Year Yet!</div>
