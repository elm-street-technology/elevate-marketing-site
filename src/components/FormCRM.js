        ...
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            ...
            const body = {
              ...values,
              notes:
                values.demorequest == true
                  ? "Requested demo, Interested Markets: " +
                    values.market1 +
                    "," +
                    values.market2 +
                    "," +
          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              <div style={{ marginBottom: "30px" }}>
                ...
                >
                  Contemporary, intuitive design for broker, agent &amp; team
                  success.
                  <br />
                  Secure personal data on every level.
                </div>
                ...
                <div style={{ marginLeft: "auto", marginRight: "auto" }}>
                  ...
                  >
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/WMqvFA708ss?autoplay=1&rel=0"
                      frameborder="0"
                ...
                <div
                  className={classes.headingText}
                  style={{ marginTop: "20px", paddingBottom: "25px" }}
                >
              ...
              >
                ...
                <div style={{ width: "100%", textAlign: "center" }}>
                  ...
                  <br />
                  Tell us your top three markets of interest. (optional)
                </div>
                <Field
                  id="market1"
                  name="market1"
