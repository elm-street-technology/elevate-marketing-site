        ...
        >
          <div>
            ...
            <Typography type="heading4" gutterTop style={{ fontSize: "18px" }}>
              A member of our Success Team will reach out shortly to finish
              activating your FREE trial account.
            </Typography>
            <hr />
            <Typography type="heading5" gutterTop style={{ fontSize: "18px" }}>
              TRAINING SERIES IN REAL ESTATE
            </Typography>
            <p>
            ...
            <p>
              <a href="https://elmstreet.com/events">Browse Upcoming Events</a>
            </p>
          </div>
        </div>
      );
        ...
        <Formik
          ...
          render={({ values, isSubmitting, handleBlur, handleChange }) => (
            <Form noValidate>
              ...
              >
                *NEW ACCOUNTS ONLY. SPECIAL PRICING DOES NOT INCLUDE ADDITIONAL
                LEAD GENERATION / PAY-PER-CLICK SERVICES.
                <br />
