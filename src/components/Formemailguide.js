...
class Formemailguide extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formState: null,
      ...
      return (
        ...
        >
          <div >
            ...
            <Typography type="heading3" gutterBottom style={{color:"#5c53a3",}}>
              Fantastic!
            </Typography>
            <div style={{margin:"50px"}}>
            <a className={classes.signUpBtn} href="/assets/email_marketing_guide.pdf">Download the PDF</a>
            </div>
          ...
          render={({ values, isSubmitting,handleBlur, handleChange }) => (
            <Form noValidate>
             ...
             <Field id="demorequest" name="demorequest" type="checkbox" value="yes" className={classes.checkfield} style={{marginLeft:"0px",marginRight:"15px"}} />
              ...
              <div style={{fontSize:"11px", lineHeight:"16px", paddingBottom:"88px"}}>
