      ...
      return (
        ...
        >
          <div >
            ...
            <Typography type="heading3" gutterBottom style={{color:"#fbba1c",}}>
              Awesome!
            </Typography>
            <div style={{margin:"50px"}}>
            <a className={classes.signUpBtn} href="/assets/rockin_website_seo.pdf">Download the PDF</a>
            </div>
            <Typography type="heading5" gutterTop style={{color:"#f7f7f7",}}>
        We’ll reach out to you asap via email or telephone.<br/>
              You can also speak to a member of our sales team immediately by calling  <a href="tel:18447920260" className={classes.link} style={{color:"#f7f7f7",}}>844.792.0260</a>.
            </Typography>
          </div>
        </div>
      );
        ...
        <Formik
          ...
          render={({ values, isSubmitting,handleBlur, handleChange }) => (
            <Form noValidate>
              ...
              <div style={{fontSize:"11px", lineHeight:"14px", paddingBottom:"55px", color:"#f7f7f7"}}>
              By submitting this form, you are requesting to be contacted by a member of the Elevate Sales Team at the details provided via text, email or call (may involve automated or pre-recorded means).  You may revoke this consent through any reasonable means.<br/>
                Existing subscribers seeking support, please visit the <a href="https://elmstreettechnology.zendesk.com/hc/en-us" style={{color:"#52B1AD"}}>Elevate Help Center</a>.
              </div>
            </Form>
          )}
        />
